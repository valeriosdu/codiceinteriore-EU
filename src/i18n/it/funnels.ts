...
const classica: FunnelCopy = {
  ...
  report: {
    sections: {
      identity: { label: 'Identità', title: 'Identità profonda' },
      emotions: { label: 'Emozioni', title: 'Dinamiche emotive' },
      relationships: { label: 'Relazioni', title: 'Relazioni e amore' },
      work: { label: 'Lavoro', title: 'Lavoro e direzione' },
      patterns_blocks: { label: 'Schemi', title: 'Schemi e blocchi ricorrenti' },
      advice: { label: 'Consigli', title: 'Consigli pratici' },
      poem: { label: 'Poesia', title: 'Poesia trasformativa' },
    },
  },
};
...
const attivazione: FunnelCopy = {
  ...
  report: {
    sections: {
      identity: { label: 'Identità', title: 'Identità profonda' },
      emotions_relationships: { label: 'Dinamiche', title: 'Dinamiche emotive e relazionali' },
      blocks_patterns: { label: 'Blocchi', title: 'Blocchi e schemi ricorrenti' },
      work_direction: { label: 'Lavoro', title: 'Lavoro e direzione' },
      advice: { label: 'Consigli', title: 'Consigli pratici' },
      poem: { label: 'Poesia', title: 'Poesia trasformativa' },
    },
  },
