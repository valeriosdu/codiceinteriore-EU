...
const PrivacyPolicyIt = () => (
  <LegalPage
    seoTitle={`Privacy Policy e Cookie Policy — ${MARKET.siteName}`}
    seoDescription={`Informativa sul trattamento dei dati personali degli utenti del sito ${MARKET.siteName}.`}
    path="/privacy"
    backAria="Indietro"
    heading="Privacy Policy e Cookie Policy"
    lastUpdated="Ultimo aggiornamento: 24 aprile 2026"
  >
    <p className="text-base leading-relaxed text-foreground/90 mb-10">
      La presente informativa descrive le modalità con cui vengono trattati i dati personali degli utenti che visitano
      il sito <SiteLink /> e utilizzano i servizi collegati al brand {MARKET.siteName}.
    </p>
    ...
    <Section title="4. Finalità del trattamento">
      ...
      <ul>
        ...
        <li>
          invio di comunicazioni operative, ad esempio conferme d'ordine, accesso ai contenuti, assistenza e notifiche
          di servizio
        </li>
    ...
    <Section title="5. Base giuridica del trattamento">
      ...
      <ul>
        ...
        <li>
          <strong>consenso dell'interessato</strong>: per l'invio di newsletter e comunicazioni marketing, nonché per
          l'uso di cookie e strumenti di tracciamento non tecnici ove richiesto dalla normativa applicabile
        </li>
        <li>
          <strong>interesse legittimo del Titolare</strong>: per esigenze di sicurezza informatica, difesa dei propri
          diritti, prevenzione di frodi, gestione tecnica del sito e analisi aggregate del funzionamento dei servizi,
    ...
    <Section title="6. Natura del conferimento">
      ...
      <p>
        Il conferimento dei dati per finalità marketing o per cookie non necessari è invece facoltativo. L'eventuale
        rifiuto non impedisce la navigazione del sito o l'acquisto del servizio base, salvo i limiti tecnici
    ...
    <Section title="7. Modalità del trattamento">
      <p>
        Il trattamento avviene con strumenti digitali e organizzativi adeguati alla natura dei dati, secondo principi di
    ...
    <Section title="8. Destinatari dei dati">
      <p>
        I dati possono essere comunicati o resi accessibili a soggetti che operano, a seconda dei casi, come responsabili
        del trattamento, autonomi titolari o persone autorizzate.
      </p>
    ...
    <Section title="9. Trattamento tramite fornitori AI e servizi esterni">
      <p>
        Per erogare alcune funzioni del servizio, i dati inseriti nel quiz e le informazioni necessarie alla generazione
        dei contenuti possono essere inviati a fornitori tecnologici esterni, inclusi servizi AI di Google e servizi
        astrologici esterni.
      </p>
      <p>
        Il Titolare adotta un criterio di minimizzazione: vengono trasmessi ai fornitori esterni solo i dati necessari a
        generare il contenuto richiesto o a eseguire la funzione tecnica prevista.
      </p>
    </Section>

    <Section title="10. Trasferimento di dati verso Paesi extra SEE">
      <p>
        Alcuni fornitori tecnologici utilizzati possono trovarsi o trattare dati in Paesi al di fuori dello Spazio
        Economico Europeo, inclusi gli Stati Uniti o altri Paesi terzi.
      </p>
      <p>
        Quando applicabile, tali trasferimenti avvengono nel rispetto degli strumenti previsti dalla normativa vigente,
        inclusi eventuali meccanismi contrattuali o altre garanzie richieste dalla legge.
      </p>
      <p>
        Per ulteriori informazioni sui trasferimenti eventualmente effettuati e sulle relative garanzie, l'utente può
        scrivere a <MailLink email={privacyEmail} />.
      </p>
    </Section>
    ...
    <Section title="11. Periodo di conservazione dei dati">
      ...
      <ul>
        ...
        <li>
          i dati relativi agli acquisti e al rapporto contrattuale possono essere conservati per la durata del rapporto e
          successivamente per il tempo necessario ad adempiere obblighi fiscali, amministrativi o difensivi
        </li>
        <li>
          i dati utilizzati per comunicazioni marketing vengono conservati fino a revoca del consenso o opposizione
          dell'interessato
        </li>
        <li>
          i dati tecnici e di log vengono conservati per il periodo strettamente necessario a garantire il funzionamento,
          la sicurezza e l'analisi dei sistemi
        </li>
        <li>
          i dati collegati ad analytics e cookie dipendono dalle impostazioni del relativo strumento e dalle preferenze
    ...
    <Section title="12. Cookie Policy">
      ...
      <SubSection title="12.1 Cosa sono i cookie">
        <p>
          I cookie sono piccoli file di testo che i siti web inviano al dispositivo dell'utente durante la navigazione.
          Possono essere memorizzati e poi ritrasmessi agli stessi siti alla visita successiva.
        </p>
        <p>
          Tecnologie simili, come pixel, tag, script o identificatori, possono svolgere funzioni analoghe di raccolta o
      ...
      <SubSection title="12.2 Tipologie di cookie utilizzate">
        ...
        <p>Servono a permettere il funzionamento del sito e l'erogazione delle funzioni essenziali, ad esempio:</p>
        <ul>
        ...
        <p>
          Il sito può utilizzare strumenti analytics come Google Analytics. Quando tali strumenti non sono configurati in
          modo strettamente aggregato o anonimizzato secondo gli standard richiesti dalla normativa applicabile, il loro
          utilizzo può richiedere il consenso dell'utente.
        </p>
        <h4 className="font-serif text-lg font-medium mt-5 mb-2">c) Cookie di marketing, profilazione e remarketing</h4>
        <p>Servono a:</p>
        <ul>
        ...
        <p>
          Questa categoria può includere strumenti come Meta Pixel e altri script o tag pubblicitari. Tali cookie non
          sono necessari al funzionamento del sito e vengono utilizzati solo sulla base del consenso, quando richiesto
      ...
      <SubSection title="12.3 Cookie di prima parte e di terza parte">
        ...
        <ul>
          ...
          <li>
            cookie di terza parte, installati tramite servizi forniti da soggetti esterni come Google, Meta, Stripe,
            PayPal o altri fornitori tecnici
          </li>
        </ul>
        <p>
          Le informazioni raccolte da cookie di terza parte sono disciplinate anche dalle informative dei rispettivi
          fornitori.
        </p>
      </SubSection>
      ...
      <SubSection title="12.5 Gestione del consenso">
        ...
        <p>
          ...
          disposizione sul sito, se presenti, oppure tramite le impostazioni del browser, fermo restando che il blocco di
          alcuni cookie può incidere sul funzionamento di alcune funzioni non essenziali.
        </p>
      </SubSection>
      <SubSection title="12.6 Disattivazione tramite browser">
        <p>
          ...
          disattivazione dei cookie tecnici potrebbe tuttavia compromettere il corretto funzionamento del sito o di
          alcune sue parti.
        </p>
      </SubSection>
      <SubSection title="12.7 Conservazione dei cookie">
        ...
        <ul>
          ...
          <li>
            altri restano memorizzati per un periodo più lungo, definito dal singolo fornitore o dalla configurazione
            tecnica del sito
          </li>
        </ul>
        <p>
    ...
    <Section title="13. Diritti dell'interessato">
      ...
      <ul>
        ...
        <li>
          revoca del consenso in qualsiasi momento, senza pregiudicare la liceità del trattamento basata sul consenso
          prestato prima della revoca
        </li>
        <li>proporre reclamo all'autorità di controllo competente</li>
      </ul>
      <p>
        Per esercitare i propri diritti, l'utente può scrivere a: <MailLink email={privacyEmail} />
      </p>
    </Section>
    ...
    <Section title="14. Minori">
      <p>
        ...
        trasmettere dati personali se non si è maggiorenni o comunque se non si ha la capacità di prestare validamente il
        consenso secondo la normativa applicabile.
      </p>
    </Section>

    <Section title="15. Modifiche alla presente informativa">
      <p>
        Il Titolare si riserva il diritto di aggiornare o modificare la presente informativa in qualunque momento. La
        versione aggiornata sarà pubblicata su questa pagina con indicazione della data di ultimo aggiornamento.
      </p>
    </Section>
  </LegalPage>
);
