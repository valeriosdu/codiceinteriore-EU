...
const IndexClassica = () => {
  ...
  // Angolo relazioni (angle-targeted): va dritto al /quiz, che è il flusso
  // self-attachment di default. La domanda di intent (?discover=1) la pone la
  // homepage generica, non questa landing.
