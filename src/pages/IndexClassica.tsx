...
// Carica Cormorant + EB Garamond solo qui (e in IndexAttivazione). Sulle altre
// pagine non sono usati: tenerli in index.html sprecherebbe ~150 KB su ogni
// first paint. Module-scope side-effect → parte appena il chunk lazy si carica.
...
const IndexClassica = () => {
  ...
  useEffect(() => {
    trackEvent("landing_classica_viewed", {}, { once: true });
  }, []);
