-- Risoluzione cross-email per admin: quando un'email non corrisponde a un
-- profilo diretto, cerca in checkout_sessions un checkout gia claimato con
-- quella customer_email e usa il profilo collegato.
--
-- Caso tipico: cliente registrato con email A, paga con email B (PayPal).
-- L'admin cerca email B → trova il cliente con email A.

-- ============================================================================
-- 1. Helper: resolve_email_key
-- ============================================================================
...
-- ============================================================================
-- 2. admin_customer_detail: risolvi email all'inizio
-- ============================================================================
...
BEGIN
  ...
  -- >>> NUOVO: risolvi email cross-account
...
-- ============================================================================
-- 3. admin_customers_search: cerca anche per email di pagamento
-- ============================================================================
