-- Aggiunge il campo "scores" (JSONB con i 6 domini) all'output della RPC
-- admin_customer_detail per le synastry_sessions. Permette alla scheda admin
-- di mostrare score raw, compresso e i 6 punteggi di dominio.
