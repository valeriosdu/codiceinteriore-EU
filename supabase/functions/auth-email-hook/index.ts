...
const EMAIL_SUBJECTS: Record<string, string> = {
  ...
  invite: 'La tua lettura ti aspetta ancora',
...
// Configuration
const SITE_NAME = "codiceinteriore"
const SENDER_DOMAIN = "notifiche.codiceinteriore.it"
const ROOT_DOMAIN = "codiceinteriore.it"
const FROM_DOMAIN = "codiceinteriore.it" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://codiceinteriore.lovable.app"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  // Pull optional user_metadata.name (set on inviteUserByEmail) so personalised
  // templates like "invite" can greet the recipient by name.
  const userMetadata =
